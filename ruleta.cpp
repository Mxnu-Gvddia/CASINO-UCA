...
void jugarRuleta(float& saldoCasino)
{
    SetConsoleOutputCP(CP_UTF8);
    saldo = (int)saldoCasino; // cargo el dinero que traigo del casino
    continuar1 = 'S';         // reinicio por si ya jugue antes
    ...
    while (continuar1 == 'S' || continuar1 == 's')
    {
        ...
        else
        {
            ...
            cout << "XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX\n";
            cout<<endl;
            saldoCasino = saldo; // guardo antes de salir
            return;
        }
    }
    saldoCasino = saldo; // guardo el dinero de vuelta al casino
}
void ColoryNumero()
{
